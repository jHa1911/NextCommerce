          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3
                  className={`text-xl font-bold mb-2 ${uploadResult.success ? "text-green-800" : "text-red-800"
                    }`}
                >
                  {uploadResult.success
                    ? "✅ Upload Successful!"
                ...
                <p
                  className={`mb-3 ${uploadResult.success ? "text-green-700" : "text-red-700"
                    }`}
                >
